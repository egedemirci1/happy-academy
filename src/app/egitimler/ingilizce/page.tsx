        ...
        <div className="container flex-1 flex flex-col justify-center">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-blue-500/20 hover:border-blue-500/40 text-center">
